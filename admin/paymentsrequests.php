...
if(isset($_REQUEST['unconfirm']))
	...
	$query = $dbh->prepare($sql);
	$query -> bindParam(':status',$mem_status, PDO::PARAM_STR);
...
<head>
	...
	<title>Manage Payments Requests</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Payments Requests</h2>
