...
<div class="form-group">
<label class="col-sm-2 control-label">Points<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="number" name="mocions" class="form-control" required value="<?php echo htmlentities($result->mocions);?>">
</div>
<label class="col-sm-2 control-label">Device Info<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="deviceinfo" class="form-control" required value="<?php echo htmlentities($result->deviceinfo);?>">
</div>
</div>
